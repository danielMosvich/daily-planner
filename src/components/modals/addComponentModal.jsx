...
const Card = styled.div`
  ...
  user-select: none;
  color: ${(props) =>
    props.status === "true" ? "white" : "var(--text-color-3)"};
  fill: ${(props) =>
    props.status === "true" ? "white" : "var(--text-color-3)"};
  stroke: ${(props) =>
    props.status === "true" ? "white" : "var(--text-color-3)"};
    ...
    <Container>
      <ContainerCards>
        <Card
          ...
          status={
            componentsArray.some((e) => e === "pomodoro") ? "true" : "false"
          }
          onClick={() => {
        ...
        <Card
          ...
          status={
            componentsArray.some((e) => e === "to-do list") ? "true" : "false"
          }
          onClick={() => {
        ...
        <Card
          ...
          status={
            componentsArray.some((e) => e === "playlist") ? "true" : "false"
          }
          onClick={() => {
        ...
        <Card
          bg={"var(--buble-gradient-4)"}
          status={componentsArray.some((e) => e === "notes") ? "true" : "false"}
          onClick={() => {
            addComponents("notes");
          }}
        >
          <Iconbuble
            status={
              componentsArray.some((e) => e === "notes") ? "true" : "false"
            }
          >
            {componentsArray.findIndex((e) => e === "notes") + 1 > 0 &&
              componentsArray.findIndex((e) => e === "notes") + 1}
          </Iconbuble>
          <IconContainer size={60}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
